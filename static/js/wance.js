          ...
          if (client.os == 'android') {
            ...
            elements.forEach(function(e) {
              ...
              for (ne = e.nextSibling; ne; ne = ne.nextSibling) {
                ...
                if (!ne.dataset.visibility) break;
              }
          ...
          (function() {
            ...
            items.forEach(function(p) {
              ...
              if (!p.classList.contains('enclosed')) {
                p.style.backgroundImage = 'url('static/images/+ i.src +')';
              ...
              expandTextNodes: function(e) {
                  ...
                  for (i = 0; i < e.childNodes.length; i++) {
                    ...
                    s = s.replace(this.regex, function(x, a) {
                          return ' < text - node > ' + escapeHtml(a) + ' < /text-node>';});w = document.createElement('text-node');w.innerHTML = s;x.replaceWith(w);while (w.childNodes.length > 0) {w.parentNode.insertBefore(w.childNodes[0],w);}w.parentNode.removeChild(w);}},};onvisible.add('#text35', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });onvisible.add('#text05', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });onvisible.add('#gallery03', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });onvisible.add('#links04', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });onvisible.add('#links03', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });ready.run();})();
    </script>
    <!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <script type="text/javascript">
          function googleTranslateElementInit() {
            new google.translate.TranslateElement({
              pageLanguage: 'en',
              includedLanguages: 'en,zh-CN,ja,ko', // Added Japanese and Korean here
        ...
        <script>
          document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
              var withinWidget = e.target.closest('#google_translate_element');
              if (withinWidget) {
                var allowedArea = e.target.closest('.allowed-click-area'); // Adjust selector as needed
                if (!allowedArea) {
                  e.preventDefault();
            ...
            translateWidget.addEventListener('mouseover', function(e) {
              // The script below is commented out because preventing default behavior on mouseover
              // typically isn't necessary and could interfere with widget functionality.
              // e.preventDefault();
